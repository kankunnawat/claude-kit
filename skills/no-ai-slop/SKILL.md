---
name: no-ai-slop
description: Use when a writing deliverable needs an AI-slop edit or voice check — message and email drafts, Slack and social posts, LinkedIn profile copy, resume and CV bullets, cover letters, PR and commit descriptions, release notes, docs and README prose, blog posts — to sharpen drafts into more human writing or detect AI patterns without rewriting. Also use when the user asks whether writing reads as AI.
---
